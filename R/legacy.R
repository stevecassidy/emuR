...
##' @description Converts an existing legacy EMU database to emuDB database structure. Converts the database configuration, copies or rewrites signal files and converts annotation data including hierarchical information.
