...
create_emuRdemoData()
# get the path to a .tpl file of a legacyEmuDB that is included the demo data
...
This will create a new emuDB in a temporary folder that is provided by `R` function `tempdir()` containing all the information specified in the `.tpl` file. The name of the new emuDB is the same as the basename of the `.tpl` file from which it was generated.  
