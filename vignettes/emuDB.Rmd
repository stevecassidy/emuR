...
Up until now we have defined the structure of our database. An essential part that is missing is of course the recordings that we wish to analyse. To import audio files into the database one simply has to:
...
import_mediaFiles(dbName, dir = fp, targetSessionName = 'wrassp')
# list session
