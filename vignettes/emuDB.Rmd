...
Up until now we have defined the structure of our database. An essential part that is missing is of course the recordings that we wish to analyse. To import audio files, refered to as media files in the context of an emuDB, into the database one simply has to:
