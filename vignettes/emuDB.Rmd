...
Up until now we have defined the structure of our database. An essential part that is missing is of course the audio files that we wish to analyse. To import audio files into the database one simply has to:
...
This document describes how to automatically build hierarchies for a given 
